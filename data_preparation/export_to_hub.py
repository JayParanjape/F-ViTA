...
def parse_args():
    ...
    parser.add_argument("--instructions_path", type=str, default="thermal_instructions.txt")
    ...
    def fn():
        for data_path in data_paths:
            yield {
                ...
                "thermal_image": {"path": data_path[1]},
            }
...
def main(args):
    ...
    for data_path in data_paths:
        ...
        thermal_image = os.path.join(data_path, "thermal_image.png")
        if not os.path.exists(thermal_image):
            continue
        if not os.path.exists(original_image):
            continue
        new_data_paths.append((original_image, thermal_image))
